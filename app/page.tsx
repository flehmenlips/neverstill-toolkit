...
const tools = [
  {
    ...
    description: 'Beautiful, developmentally-aware PDFs for handwriting, mazes, arithmetic and more. Hosted PWA with difficulty presets + Python for creators & packs.',
    status: 'PWA live • Packs shipping',
